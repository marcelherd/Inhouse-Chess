export type Country = {
  /** ISO 3166 Alpha-2 format with 2 letter country codes */
  code: string;

  /** ISO 3166 Alpha-3 format with 3 letter country codes */
  code3: string;

  /** Country name in English */
  name: string;

  /** ISO 3166 numeric format */
  number: string;
};

/**
 * Contains all countries in various ISO 3166 formats.
 *
